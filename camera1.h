    ...
    class Camera1
    {
     public:
        Camera1()
        {
            ...
            position_rot = glm::vec3(0, 2, 5);
            forward_rot = glm::vec3(0, 0, -1);
            up_rot = glm::vec3(0, 1, 0);
            right_rot = glm::vec3(1, 0, 0);

            distanceToTarget = 2;
        }

        Camera1(const glm::vec3 &position, const glm::vec3 &center, const glm::vec3 &up, const int distanceToTarget)
        {
        ...
        // Update camera
        void Set(const glm::vec3 &position, const glm::vec3 &center, const glm::vec3 &up, const int distanceToTarget)
        {
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 compute = glm::rotate(glm::mat4(1), angle, right) * glm::vec4(forward, 1);
            forward = compute;
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 compute = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1);
            forward = compute;
            forward = glm::normalize(forward);

            compute = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
            right = compute;
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 compute = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 0, 1)) * glm::vec4(right, 1);
            right = compute;
            right = glm::normalize(right);
     ...
     public:
        ...
        glm::vec3 position, position_rot;
        glm::vec3 forward, forward_rot;
        glm::vec3 right, right_rot;
        glm::vec3 up, up_rot;
    };
}   // namespace implemented
